...
import requests
def test_external_call(mocker): # requires pytest-mock to be
    # Patch 'requests.get' so it returns "mocked" instead of doing a
    mocker.patch("requests.get", return_value="mocked")
